...
| V1-C5 | none (new contract) | VR-AST-001, VR-AST-002, VR-AST-004, VR-FAIL-003 | Core | Clarifying | Require fixed asset set including diagnostics and Linux container packed library, and fail when required assets are missing. | A-010, A-011 |
