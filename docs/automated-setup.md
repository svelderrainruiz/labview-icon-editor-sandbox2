...
- **Prerequisites**:
  1. **LabVIEW 2021 SP1 (both 32-bit and 64-bit)**; the 64-bit install is used for package building.
  2. **PowerShell 7+** and **Git**.  
  3. **Apply** `.github\actions\apply-vipc\runner_dependencies.vipc` to **LabVIEW 2021 (32-bit & 64-bit)**.
...
3. **Apply** dependencies:  
   `.github\actions\apply-vipc\runner_dependencies.vipc` to **LabVIEW 2021 (32-bit & 64-bit)**.
