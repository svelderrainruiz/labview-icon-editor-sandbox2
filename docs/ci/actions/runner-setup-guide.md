...
> **Prerequisites**:
> - **LabVIEW matching `.lvversion` (currently 26.1), 32-bit and 64-bit**.
...
1. **Install Required Software**
   - Ensure **LabVIEW matching `.lvversion` (currently 26.1), 32-bit and 64-bit** are installed.
   - [PowerShell 7+](https://github.com/PowerShell/PowerShell/releases/latest)
   - [Git for Windows](https://github.com/git-for-windows/git/releases/latest)

2. **Apply the VIPC**
  - Apply `.github/actions/apply-vipc/runner_dependencies.vipc` with VIPM in **LabVIEW 2026 (32-bit)**; repeat for **LabVIEW 2026 (64-bit)**.
...
1. **Install LabVIEW matching `.lvversion` (currently 26.1), 32-bit and 64-bit**  
