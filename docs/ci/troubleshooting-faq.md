...
2. [FAQ](#faq)
   ...
   9. [Q9: Can I Use a Different LabVIEW Version (e.g., 2022)?](#q9-can-i-use-a-different-labview-version-eg-2022)
...
### Q9: Can I Use a Different LabVIEW Version (e.g., 2022)?

**Answer**:  
The default scripts and docs target **LabVIEW 2021 SP1** for tests, builds, and packaging. You can use a different version if your machine and project support it, but you’ll need to install that version on your self-hosted runner and update environment variables or script inputs (for example, the LabVIEW EXE path). Validate compatibility in your environment before relying on it.
